...
## Sum of stems per size class category by plot.  To view a plot select from dropdown, or download compiled PDF [here](https://github.com/rswaty/ABRPweb/raw/master/groupedPineStems.pdf). 
