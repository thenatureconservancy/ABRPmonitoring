...
Number of stems per size class category.  To view one plot at a time select from drop down below, or download compiled PDF [here](https://github.com/rswaty/ABRPweb/find/master). 
