...
## This page...
On this page several ways to explore patterns in pine seedlings (counts coded-see note below) are presented.  
...
# Seedlings per BP over time


 Number of stems per size class category.  To view limited number of plots select from dropdown, or download compiled PDF [here](https://github.com/rswaty/ABRPweb/raw/master/pineSeedlingCats.pdf). 
...
```
 ...
 Number of stems per size class category.  To view limited number of plots select from dropdown, or download compiled PDF [here](https://github.com/rswaty/ABRPweb/raw/master/pineSeedlingRAW.pdf). 
