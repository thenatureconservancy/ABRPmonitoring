...
## Grouped Pine Data
David and Chaz provided a grouping scheme.  This was added to the pine data as a new columm, then due to time was formatted for the final [groupedPine](https://tnc.box.com/s/tk6evuux2zzud2a28mzfvx2zkz5gz1oq) dataset. 
...
* Beatriz provided additional cleaning.  Her notes and cleaned data are in an Excel file named [Copy of Herbaceous data - BPA](https://tnc.box.com/s/tk6evuux2zzud2a28mzfvx2zkz5gz1oq).  This data replaced all other data and was pasted into other herb datasets.
